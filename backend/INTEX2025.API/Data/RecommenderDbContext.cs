...
public class RecommenderDbContext : DbContext
{
    ...
    // Table: top10_movietitle - Top 10 recommendations based on movie title similarity
    public DbSet<Top10MovieTitle> Top10MovieTitles { get; set; }
    ...
    // Table: topmovies - List of top movies with genre and title info
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Top10MovieTitle>().ToTable("top10_movietitle").HasNoKey();
        ...
        modelBuilder.Entity<TopMovies>().ToTable("topmovies").HasNoKey();
    }
}